...
The `aws_sdk_bedrock_agentcore` client is still under active development.
...
follow the instructions in the docs [README.md](https://github.com/aws/aws-sdk-python/blob/main/clients/aws-sdk-bedrock-agentcore/docs/README.md).
